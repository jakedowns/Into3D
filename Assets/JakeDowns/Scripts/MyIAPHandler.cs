...
public class MyIAPHandler : MonoBehaviour, IStoreListener
{
    ...
    const string _3DModeProductID = "com.jakedowns.180_360_3d_mode";
...
//    }
    ...
    {
        Debug.LogError("Error initializing IAP " + error + ". message: " + message);
    }
        ...
        if (isPurchaseValid)
        {
            ...
            else
            {
                jakesRemoteController.ShowCustomPopup(
                    ...
                    "Please try again later or contact into3d@jakedowns.com"
                );
            }
        }
        else

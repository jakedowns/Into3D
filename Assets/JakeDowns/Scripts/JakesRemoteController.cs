...
public class JakesRemoteController : MonoBehaviour
{
    ...
    GameObject _whats_new_popup_title = null;
    GameObject _picture_settings_popup = null;
    GameObject _downloading_popup = null;
    GameObject _stream_options_popup = null;
    ...
    void Start()
    {
        ...
        string version_code = Application.buildGUID;

        if (PlayerPrefs.GetString("OnboardingSeen") == version_code)
        {
        ...
        else
        {
            ...
            PlayerPrefs.SetString("OnboardingSeen", version_code);
            ShowWhatsNewPopup();
        }
    }
    ...
    public void UpdateReferences()
    {
        ...
        _downloading_popup = FindGameObjectsAllFirst("DownloadingPopup");
        _stream_options_popup = FindGameObjectsAllFirst("StreamOptionsPopup");
    }
    ...
    public void HideAllPopups()
    {
        ...
        HidePopupByID(PopupID.DOWNLOAD_POPUP);
        HidePopupByID(PopupID.STREAM_OPTIONS_POPUP);
    }
    ...
    public void ShowPopupByID(PopupID popupID)
    {
        ...
        switch (popupID)
        {
            ...
            case PopupID.CUSTOM_AR_POPUP:
                ShowCustomARPopup();
                break;
            case PopupID.DOWNLOAD_POPUP:
                ShowDownloadingPopup();
                break;
            case PopupID.STREAM_OPTIONS_POPUP:
    ...
    public void ShowWhatsNewPopup()
    {
        ...
        _whats_new_popup_title = GameObject.Find("WhatsNewPopup/PopupInner/Modal/Title");
        _whats_new_popup_title.GetComponent<Text>().text = $"What's New? {Application.version}";
    }
    ...
    {
        UpdateReferences();
        if (_downloading_popup == null)
        {
            Debug.LogError("error finding downloading popup");
            return;
        }
        _downloading_popup.SetActive(true);
    }

    public void UpdateDownloadingPopup(float percent)
    {
        downloadProgressBar.value = percent;
    }

    public void HideDownloadingPopup()
    {
        _downloading_popup.SetActive(false);
    }

    public void ShowStreamOptionsPopup()
    {
        _stream_options_popup.SetActive(true);
    }

    public void HideStreamOptionsPopup()
    {
        _stream_options_popup.SetActive(false);
    }
